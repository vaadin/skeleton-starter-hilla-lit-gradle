...
This project can be used as a starting point to create your own Hilla application with Lit, Spring Boot, and Gradle.
...
`java -jar build/libs/skeleton-starter-hilla-lit-gradle.jar`
